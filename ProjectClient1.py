...
s.sendall(b'Client2: ' + encodedPlay)
    ...
    if opponentPlay == "your opponent did not want to play":
        ...
        while True:
            ...
            if len(a) != 5:
                ...
                s.sendall(b'Client2: ' + encodedInput)
                ...
                for i in range(10):
                    ...
                    s.sendall(b'Client2: ' + guessInput)
                    print(s.recv(500).decode('utf-8'))
                    if b == "guess":
                        break
                    elif i == 9:
                ...
                s.sendall(b'Client1: ' + finalGuessInput)          
                ...
                while "rock" in finalResult or "paper" in finalResult or "scissors" in finalResult:
                    ...
                    s.sendall(b'Client2: ' + encodedRPS)
